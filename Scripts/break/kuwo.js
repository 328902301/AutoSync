...
var modBody = $response.body;

if (url.includes("/a.p")) {
  let modBody = $response.body
  ...
  modBody = JSON.stringify(_0xf48cd5);
  let _0x2326b4 = {};
...
if (url.includes("/music.pay")) {
  if (modBody.includes("audio")) {
    let _0xf48cd5 = JSON.parse(modBody);
    let _0x507dcb = _0xf48cd5["songs"][0x0]["id"];
    let _0x20bb38 = _0xf48cd5["songs"][0x0]["audio"][0x0]["pid"];
    let _0x5392b0 = _0xf48cd5["songs"][0x0]["audio"][0x0]["price"];
    let _0x274ae8 = _0xf48cd5["songs"][0x0]["audio"][0x0]["policy"];
    let _0x108023 = _0x274ae8 + "_1";
    let _0x20d61f = _0xf48cd5["songs"][0x0]["audio"]["length"];
    for (let _0x2644a8 = 0x0; _0x2644a8 < _0x20d61f; _0x2644a8++) {
      _0xf48cd5["songs"][0x0]["audio"][_0x2644a8]["st"] = 0x0;
    }
    let _0x2dd3e8 = _0xf48cd5["songs"][0x0];
    let _0x27cbb9 = {};
