...
const imax = {
  js: {
    ...
    contentFarm:
      "https://gitlab.com/RuCu6/QuanX/-/raw/main/Scripts/limbo/contentFarm/contentFarm.js" // 内容农场
  },
  css: {
    ...
    btbdys:
      '.ayx[style^="position: fixed;bottom"],#ad-index,#adsbox,.ayx[style="display:block;"],.ayx[style^="position: fixed;bottom"],a[target*=_new] {display:none !important;}', // 哔滴影视
    ...
    dy555:
      '.playtop.col-pd,a[href*="?channelCode="] > img[src*=".com:"],#adsbox,div.myui-panel.myui-panel-bg.clearfix.wapad {display:none !important}', // 555影院
    wnacg: "div > img[src*='gif'],div.sh,div > a[target='_blank'] > img {display:none!important}", // 绅士漫画
    missav:
      "div[style*='z-index: 1001'],ul.space-y-2.mb-4.ml-4.list-disc.text-nord14,div.space-y-5.mb-5,div.under_player,div[style=\"width: 300px; height: 250px;\"] {display:none!important}", //  MissAV
    ...
    pornhubx:
      "[rel*='noopener nofollow'],a[href^=\"http://ads.trafficjunky.net/\"],.topAdContainter,.adsbytrafficjunky,.ad-link,a[target='_blank']", // pornhub
    ...
    case "missav":
      ...
      if (ua_missav.indexOf(mobile_missav) === -1) {
        ...
        button_dynamicAppend(
          ...
          "background: red !important; position:fixed; top:100px; border-right: 6px solid #ffc107 !important;",
          "how",
          3
        );
        ...
        button_dynamicAppend(
          ...
          "下载视频",
          'window.open("https://limbopro.com/archives/M3U8-Downloader.html", "_blank")',
          "background: red !important; position:fixed; border-right: 6px solid #ffc107 !important;",
          "how",
          3
        );
      }
    ...
    case "jable":
      ...
      if (ua.indexOf(mobile) === -1) {
        ...
        button_dynamicAppend(
          ...
          "下载视频",
          'window.open("https://limbopro.com/archives/M3U8-Downloader.html", "_blank")',
          "background: red !important; position:absolute; right:0px; border-right: 6px solid #ffc107 !important;",
          "how",
          2
        );
        ...
        button_dynamicAppend(
          ...
          "下载视频",
          'window.open("https://limbopro.com/archives/M3U8-Downloader.html", "_blank")',
          "background: purple !important; position:absolute; right:0px; border-right: 6px solid #ffc107 !important;",
          "how",
          2
        );
      }
...
function button_dynamicAppend(ele, text, onclick, position, id, array) {
  ...
  var button_style_values =
    position +
    "padding: 6px 6px 6px 6px; display: inline-block; " +
...
function videoAds_accelerateSkip(fasterx) {
  ...
  boost =
    isNaN(boost) === false && isFinite(boost) ? Math.min(Math.max(boost, fasterx), 50) : fasterx;
