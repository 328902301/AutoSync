...
function FindProxyForURL(url, host) {
	...
	var WHITE_SUBDOMAINS = ["push.apple.com"];
	var WHITE_URLS = [];
	var WHITE_NETWORKS = [];
	var WHITE_MASKS = [];
