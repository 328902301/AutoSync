...
async function retryCdn(code, url) {
    if (code === 'error') {
        ...
        let cndUrl = `https://gitlab.com/fmz200/cuttlefish/-/raw/master/Jd/jd-live-rain.json`
...
function rraUrl() {
    let url = 'https://gitlab.com/fmz200/cuttlefish/-/raw/master/Jd/jd-live-rain.json'
