...
rawadMiTM = requests.get("https://raw.githubusercontent.com/blackmatrix7/ios_rule_script/master/rule/Surge/Advertising/Advertising_MITM.sgmodule
").text
                         

result = rawfirsti.split("\n") + rawBiliBili.split("\n") + rawadMiTM.split("\n")
