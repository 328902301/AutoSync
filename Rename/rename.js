...
const inputFuncsList = {
  zh: (inputList = zh),
  enFull: (inputList = enFull),
  enShort: (inputList = enShort),
};

const inputFunc = inputFuncsList[$arguments.input];
...
// 获取机场名
const airport = ($arguments.airport == undefined) ? $arguments.airport == '' : decodeURI($arguments.airport);
