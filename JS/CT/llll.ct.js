...
function CryptoJSAES() {
   ...
   */
    ...
    //
    const key = CryptoJS.enc.Utf8.parse("hbdxWxSmall96548");  //十六位十六进制数作为密钥
    const iv = CryptoJS.enc.Utf8.parse("6606136474185246");   //十六位十六进制数作为密钥偏移量

    //解密方法
    this.Decrypt = function Decrypt(word) {
    ...
    //加密方法
    this.Encrypt = function Encrypt(word) {
