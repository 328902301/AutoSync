    ...
    case /^https?:\/\/app\.bilibili\.com\/x\/v2\/account\/mine/.test(
      ...
      try {
        ...
        m.data.sections_v2.forEach((t, i) => {
          ...
          for (let a = 0; a < m.data.sections_v2.length; a++)
            ("创作中心" == m.data.sections_v2[a].title ||
              "創作中心" == m.data.sections_v2[a].title) &&
              (delete m.data.sections_v2[a].title,
              delete m.data.sections_v2[a].type);
    ...
    case /^https?:\/\/app\.bilibili\.com\/x\/resource\/show\/skin\?/.test(
      ...
      try {
        ...
        q &&
          ...
          q.data.hasOwnProperty("common_equip") &&
          q.data.common_equip.hasOwnProperty("package_url"),
