...
var inputFuncsList = {
    zh: addVar(inputList, zh);
    enFull: addVar(inputList, enFull);
    enShort: addVar(inputList, enShort);
};

var inputFunc = inputFuncsList[$arguments["input"]];
(!inputFunc) && throw new Error('Invalid value ' + $arguments["input"]); inputFunc();
...
// 获取机场名
var airport = ($arguments["airport"] == undefined) ? $arguments["airport"] == '' : decodeURI($arguments["airport"]);
